//const {movieObj}=props;bu yapıcı metod gibidir ve props yerine artık bu aşşağıdakini kullanabiliriz. function Movie({movieObj})
  ...
  return (
    <div className="col">
      ...
      <div className="card-body">
        ...
        {
          movieObj.is_new&&(
            <span className='position-absolute top-0 start-0 badge bg-danger m-1'>New</span>
          )
        }
      </div>
    </div>
